...
class ApplicationWindow(QtWidgets.QMainWindow):
    ...
    #================================== simiarity hashes of Spectrograms  and Hashes of Feature Spectrograms================
        print("Length of spectral centroid array")
        print(len(self.spectral_Centroid))
        print("Length of array of Hash feature")
        print(len(self.arrayofHashFeature))
        for i in range(len(self.arrayofHashFeature)):
            self.sumf.append(self.similarityFeature1[i]+self.similarity[i])
        print(self.sumf)
